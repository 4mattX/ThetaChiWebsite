...
<!--<div class="z-50 bg-base-100 w-full h-5 opacity-80">-->

<!--</div>-->

<!--<svg xmlns="http://www.w3.org/2000/svg" class="z-50 fill-base-100 opacity-80 -scale-x-100 py-5" viewBox="0 0 1440 320">-->
...
<div class="navbar bg-base-100 z-50 bg-opacity-0">

...
<main>
    ...
    <Navbar />
    <InfoNav title={'Action Select'} />

    <div class="py-32 px-5 bg-secondary h-screen">
        <div class="flex flex-col justify-center items-center bg-white rounded-xl shadow-xl">

            <div class="prose">

                <div class="bg-neutral my-20 mx-5">
                    <h3 class="bg-accent text-white px-5">Scanned Item</h3>

                    <div class="px-5">
                        <h5>UPC Code: {itemId}</h5>
                        <h5>Item Name: {itemName}</h5>
                        <h5>Item Price: {itemPrice}</h5>
                        <h5>Item Description: {itemDescription}</h5>
                    </div>
                </div>
